...
$company = array(
  ...
  'id'           => 'company',
  'value'        => set_value("supplier[company]", ""),
...
$fullname = array(
  ...
  'id'           => 'fullname',
  'value'        => set_value("supplier[fullname]", ""),
...
$phone = array(
  'name'         => 'supplier[phone]',
  'id'           => 'phone',
  'value'        => set_value("supplier[phone]", ""),
  'placeholder'  => "ex: 222 333 444",
  'class'        => "form-control",
  'autocomplete' => "off"
);
$vat_number = array(
  ...
  'id'           => 'vat_number',
  'value'        => set_value("supplier[vat_number]", ""),
...
$email = array(
  'name'         => 'supplier[email]',
  'id'           => 'email',
  'value'        => set_value("supplier[email]", ""),
...
$website = array(
  ...
  'id'           => 'website',
  'value'        => set_value("supplier[website]", ""),
...
$address = array(
  ...
  'id'           => 'address',
  'value'        => set_value("supplier[address]", ""),
...
$address2 = array(
  ...
  'id'           => 'address2',
  'value'        => set_value("supplier[address2]", ""),
...
$state = array(
  'name'         => 'supplier[state]',
  'id'           => 'state',
  'value'        => set_value("supplier[state]", ""),
...
$postal_code = array(
  ...
  'id'           => 'postal_code',
  'value'        => set_value("supplier[postal_code]", ""),
...
if( !empty($this->settings_model->SYS_Settings->supplier_cf1) ){
  $cf1 = array(
    ...
    'id'           => 'cf1',
    'value'        => set_value("supplier[custom_field1]", ""),
    'class'        => 'form-control',
    'autocomplete' => "off"
  );
}else{
...
if( !empty($this->settings_model->SYS_Settings->supplier_cf2) ){
  $cf2 = array(
    ...
    'id'           => 'cf2',
    'value'        => set_value("supplier[custom_field2]", ""),
    'class'        => 'form-control',
    'autocomplete' => "off"
  );
}else{
...
if( !empty($this->settings_model->SYS_Settings->supplier_cf3) ){
  $cf3 = array(
    ...
    'id'           => 'cf3',
    'value'        => set_value("supplier[custom_field3]", ""),
    'class'        => 'form-control',
    'autocomplete' => "off"
  );
}else{
...
if( !empty($this->settings_model->SYS_Settings->supplier_cf4) ){
  $cf4 = array(
    ...
    'id'           => 'cf4',
    'value'        => set_value("supplier[custom_field4]", ""),
    'class'        => 'form-control',
    'autocomplete' => "off"
  );
}else{
...
<hr />
<?php echo form_open("suppliers/create", array('class' => 'form-horizontal'));?>
          ...
          <div class="input-group">
            <div class="input-group-addon" style="padding: 0;min-width: 70px;border: none;">
              ...
              foreach ($phones as $phone_row) {
                  echo "<option value='".$phone_row->phone."' data-flag='".$phone_row->code."' ".($phone_row->phone==set_value("phone_code", DEFAULT_PHONE_CODE)?"selected='selected'":"" ).">".$phone_row->label."</option>";
              }
              echo "</select>";
              ?>
            </div>
          ...
          <div class="row row-equal">
            <div class="col-md-12">
              ...
              foreach ($countries as $code => $country) {
                  echo "<option value='".$country."' data-flag='".$code."' ".($country==set_value("supplier[country]", DEFAULT_COUNTRY)?"selected='selected'":"").">".$country."</option>";
              }
              echo "</select>";
              ?>
            </div>
