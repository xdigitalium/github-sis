...
$company = array(
  'name'         => 'biller[company]',
  'id'           => 'company',
  'value'        => set_value("biller[company]", ""),
...
$fullname = array(
  ...
  'id'           => 'fullname',
  'value'        => set_value("biller[fullname]", ""),
...
$vat_number = array(
  ...
  'id'           => 'vat_number',
  'value'        => set_value("biller[vat_number]", ""),
...
$website = array(
  'name'         => 'biller[website]',
  'id'           => 'website',
  'value'        => set_value("biller[website]", ""),
...
$address = array(
  'name'         => 'biller[address]',
  'id'           => 'address',
  'value'        => set_value("biller[address]", ""),
...
$address2 = array(
  ...
  'id'           => 'address2',
  'value'        => set_value("biller[address2]", ""),
...
$postal_code = array(
  ...
  'id'           => 'postal_code',
  'value'        => set_value("biller[postal_code]", ""),
...
if( !empty($this->settings_model->SYS_Settings->customer_cf1) ){
  $cf1 = array(
    ...
    'id'           => 'cf1',
    'value'        => set_value("biller[custom_field1]", ""),
    'class'        => 'form-control',
    'autocomplete' => "off"
  );
}else{
...
if( !empty($this->settings_model->SYS_Settings->customer_cf2) ){
  $cf2 = array(
    ...
    'id'           => 'cf2',
    'value'        => set_value("biller[custom_field2]", ""),
    'class'        => 'form-control',
    'autocomplete' => "off"
  );
}else{
...
if( !empty($this->settings_model->SYS_Settings->customer_cf3) ){
  $cf3 = array(
    ...
    'id'           => 'cf3',
    'value'        => set_value("biller[custom_field3]", ""),
    'class'        => 'form-control',
    'autocomplete' => "off"
  );
}else{
...
if( !empty($this->settings_model->SYS_Settings->customer_cf4) ){
  $cf4 = array(
    ...
    'id'           => 'cf4',
    'value'        => set_value("biller[custom_field4]", ""),
    'class'        => 'form-control',
    'autocomplete' => "off"
  );
}else{
...
<hr />
<?php echo form_open("billers/create", array('class' => 'form-horizontal'));?>
          ...
          <div class="row row-equal">
            <div class="col-md-12">
              ...
              foreach ($countries as $code => $country) {
                  echo "<option value='".$country."' data-flag='".$code."' ".($country==set_value("biller[country]", DEFAULT_COUNTRY)?"selected='selected'":"").">".$country."</option>";
              }
              echo "</select>";
              ?>
            </div>
