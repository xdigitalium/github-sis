...
$date_hidden = array(
  'type'         => 'hidden',
  'name'         => 'expense[date]',
  'value'        => set_value("expense[date]", date_MYSQL_JS(date("Y-m-d"))),
);
$date_due = array(
  "id"           => "date_due",
  "class"        => "form-control"
...
$date_due_hidden = array(
  ...
  'value'        => set_value("expense[date_due]", ""),
);
$payment_date = array(
  "id"           => "payment_date",
  "class"        => "form-control"
...
$payment_date_hidden = array(
  ...
  'value'        => set_value("expense[payment_date]", ""),
);
$category = array(
  "id"           => "category",
  "class"        => "form-control"
...
$details = array(
  ...
  'id'           => 'editor_details',
  'value'        => html_entity_decode(set_value("expense[details]", "")),
  'class'        => 'form-control',
  'rows'         => 5,
  'autocomplete' => "off"
);
$reference = array(
  ...
  'id'           => 'reference',
  'value'        => set_value("expense[reference]", ""),
  "class"        => "form-control",
...
<hr />
<?php echo form_open("expenses/create/", array('class' => 'form-horizontals'));?>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group m-a-0 required">
              ...
              <div class="input-group">
                ...
                <input type="number" step="1" min="<?php echo $next_number ?>" value="<?php echo set_value("expense[number]", $next_number) ?>" name="expense[number]" tabindex="1" class="form-control" id="number" />
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="form-group m-a-0 required">
              ...
              foreach ($categories as $cat) {
                if( $cat["is_default"] ){
                  $default_cat = $cat["label"];
                }
                $cats[$cat["type"]][$cat["label"]] = $cat["label"];
              }
              echo form_dropdown('expense[category]', $cats, $default_cat, $category);
              ?>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group m-a-0 required">
              ...
              <div class="input-group">
                <input type="number" step="any" min="0" value="<?php echo set_value("expense[amount]", 0) ?>" name="expense[amount]" class="form-control" id="amount" />
          ...
          <div class="col-md-6">
            <div class="form-group m-a-0 required">
              ...
              foreach ($this->settings_model->getFormattedCurrencies() as $currency) {
                  echo "<option value='".$currency->value."' symbol_native='".$currency->symbol_native."' ".($currency->value==CURRENCY_PREFIX?"selected='selected'":"" ).">".$currency->label."</option>";
              }
              echo "</select>";
              ?>
            </div>
          ...
          <div class="col-md-6">
            <div class="form-group m-a-0 required">
              ...
              echo form_dropdown('expense[payment_method]', $methods, set_value("expense[payment_method]", ""), $method);
              ?>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group m-a-0 required">
              ...
              echo form_dropdown('expense[status]', $status, set_value("expense[status]", "unpaid"), $exp_status);
              ?>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group m-a-0 required">
              ...
              echo form_dropdown('expense[tax_id]', $taxes, '', 'class="form-control" id="tax"');
              ?>
              <input type="hidden" name="expense[tax_type]" value="0" id="tax_type">
              <input type="hidden" name="expense[tax_value]" value="0" id="tax_value">
              <input type="hidden" name="expense[tax_total]" value="0" id="tax_total">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group m-a-0">
          ...
          <div class="col-md-6 ">
            <div class="form-group m-a-0">
              ...
              <div class="input-group">
                <span class="form-control" id="total_shown">0.00</span>
                <input type="hidden" name="expense[total]" value="0" id="total">
                <span class="input-group-addon" ><?php echo CURRENCY_SYMBOL ?></span>
              </div>
            </div>
            <div class="form-group m-a-0 required">
...
<script type="text/javascript">
  ...
  $("#date, #date_due, #payment_date").mask(MASK_DATE,{placeholder:JS_DATE});
