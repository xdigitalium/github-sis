...
$tax_rate_value = array(
  "name" => 'tax_rate[value]',
  "value" => set_value('tax_rate[value]', $tax_rate->value),
...
<hr />
<?php echo form_open("settings/update_tax_rate?id=".$tax_rate->id, array('class' => 'form-horizontal'));?>
<?php echo form_hidden('id', $tax_rate->id); ?>
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    <div class="row form-group ">
      <label class="col-md-3 form-control-label required" for="tax_rate_label"><?php echo lang('tax_rate_label');?></label>
      <div class="col-md-9">
        <?php echo form_input('tax_rate[label]', set_value('tax_rate[label]', $tax_rate->label), $tax_rate_label); ?>
      </div>
    </div>
    <div class="row form-group">
    ...
    <div class="row form-group">
      ...
      <div class="col-md-9">
        <?php echo form_dropdown('tax_rate[type]', $tax_rate_types, set_value("tax_rate[type]", $tax_rate->type), $tax_rate_type); ?>
      </div>
    </div>
    <div class="row form-group">
      ...
      <div class="col-md-9">
          <label class="switch switch-xs switch-icon switch-primary-outline-alt" style="margin-top: 9px;vertical-align: middle;">
            <?php echo form_checkbox('tax_rate[is_default]', '1', set_value("tax_rate[is_default]", $tax_rate->is_default), 'id="is_default" class="switch-input"');?>
